...
public class ModLanguageProvider extends AbstractLanguageProvider {
    ...
    public void addTranslations(TranslationBuilder builder) {
        ...
        builder.add(ModRegistry.CONCUSSION_CREEPER_SPAWN_EGG_ITEM.value(), "Concussion Creeper Spawn Egg");
        builder.add(ModRegistry.INFESTED_ZOMBIE_SPAWN_EGG_ITEM.value(), "Infested Zombie Spawn Egg");
        builder.add(ModRegistry.ENDERMINY_SPAWN_EGG_ITEM.value(), "Enderminy Spawn Egg");
        builder.add(ModRegistry.DIRE_WOLF_SPAWN_EGG_ITEM.value(), "Dire Wolf Spawn Egg");
        builder.add(ModRegistry.FALLEN_MOUNT_SPAWN_EGG_ITEM.value(), "Fallen Mount Spawn Egg");
        builder.add(ModRegistry.WITHER_CAT_SPAWN_EGG_ITEM.value(), "Wither Cat Spawn Egg");
        builder.add(ModRegistry.WITHER_WITCH_SPAWN_EGG_ITEM.value(), "Wither Witch Spawn Egg");
        builder.add(ModRegistry.OWL_SPAWN_EGG_ITEM.value(), "Owl Spawn Egg");
        builder.add(ModRegistry.FALLEN_KNIGHT_SPAWN_EGG_ITEM.value(), "Fallen Knight Spawn Egg");
