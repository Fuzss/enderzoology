...
public class EnderZoology implements ModConstructor {
    ...
    private static void registerBrewingRecipes() {
        PotionBrewingRegistry.INSTANCE.registerPotionRecipe(Potions.AWKWARD,
                ModRegistry.ENDER_FRAGMENT_ITEM.value(),
                ModRegistry.DISPLACEMENT_POTION.value()
        );
        PotionBrewingRegistry.INSTANCE.registerPotionRecipe(ModRegistry.DISPLACEMENT_POTION.value(),
                Items.GLOWSTONE_DUST,
                ModRegistry.STRONG_DISPLACEMENT_POTION.value()
        );
        PotionBrewingRegistry.INSTANCE.registerPotionRecipe(Potions.AWKWARD,
                ModRegistry.WITHERING_DUST_ITEM.value(),
                ModRegistry.DECAY_POTION.value()
        );
        PotionBrewingRegistry.INSTANCE.registerPotionRecipe(ModRegistry.DECAY_POTION.value(),
                Items.REDSTONE,
                ModRegistry.LONG_DECAY_POTION.value()
        );
        PotionBrewingRegistry.INSTANCE.registerPotionRecipe(ModRegistry.DECAY_POTION.value(),
                Items.GLOWSTONE_DUST,
                ModRegistry.STRONG_DECAY_POTION.value()
        );
        PotionBrewingRegistry.INSTANCE.registerPotionRecipe(Potions.AWKWARD,
                ModRegistry.CONFUSING_POWDER_ITEM.value(),
                ModRegistry.CONFUSION_POTION.value()
        );
        PotionBrewingRegistry.INSTANCE.registerPotionRecipe(ModRegistry.CONFUSION_POTION.value(),
                Items.REDSTONE,
                ModRegistry.LONG_CONFUSION_POTION.value()
        );
        PotionBrewingRegistry.INSTANCE.registerPotionRecipe(ModRegistry.CONFUSION_POTION.value(),
                Items.GLOWSTONE_DUST,
                ModRegistry.STRONG_CONFUSION_POTION.value()
        );
        PotionBrewingRegistry.INSTANCE.registerPotionRecipe(Potions.AWKWARD,
                ModRegistry.OWL_EGG_ITEM.value(),
                ModRegistry.RISING_POTION.value()
        );
        PotionBrewingRegistry.INSTANCE.registerPotionRecipe(ModRegistry.RISING_POTION.value(),
                Items.REDSTONE,
                ModRegistry.LONG_RISING_POTION.value()
        );
    }
    ...
    public void onEntityAttributeCreation(EntityAttributesCreateContext context) {
        context.registerEntityAttributes(ModRegistry.CONCUSSION_CREEPER_ENTITY_TYPE.value(),
                EntityAttributeProviders.createConcussionCreeperAttributes()
        );
        context.registerEntityAttributes(ModRegistry.INFESTED_ZOMBIE_ENTITY_TYPE.value(),
                EntityAttributeProviders.createEnderInfestedZombieAttributes()
        );
        context.registerEntityAttributes(ModRegistry.ENDERMINY_ENTITY_TYPE.value(),
                EntityAttributeProviders.createEnderminyAttributes()
        );
        context.registerEntityAttributes(ModRegistry.DIRE_WOLF_ENTITY_TYPE.value(),
                EntityAttributeProviders.createDireWolfAttributes()
        );
        context.registerEntityAttributes(ModRegistry.FALLEN_MOUNT_ENTITY_TYPE.value(),
                EntityAttributeProviders.createFallenMountAttributes()
        );
        context.registerEntityAttributes(ModRegistry.WITHER_CAT_ENTITY_TYPE.value(),
                EntityAttributeProviders.createWitherCatAttributes()
        );
        context.registerEntityAttributes(ModRegistry.WITHER_WITCH_ENTITY_TYPE.value(),
                EntityAttributeProviders.createWitherWitchAttributes()
        );
        context.registerEntityAttributes(ModRegistry.OWL_ENTITY_TYPE.value(),
                EntityAttributeProviders.createOwlAttributes()
        );
        context.registerEntityAttributes(ModRegistry.FALLEN_KNIGHT_ENTITY_TYPE.value(),
    ...
    public void onRegisterSpawnPlacements(SpawnPlacementsContext context) {
        context.registerSpawnPlacement(ModRegistry.CONCUSSION_CREEPER_ENTITY_TYPE.value(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                SpawnPlacementRules::checkSurfaceSpawnRules
        );
        context.registerSpawnPlacement(ModRegistry.INFESTED_ZOMBIE_ENTITY_TYPE.value(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                SpawnPlacementRules::checkSurfaceSpawnRules
        );
        context.registerSpawnPlacement(ModRegistry.ENDERMINY_ENTITY_TYPE.value(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                SpawnPlacementRules::checkSurfaceSpawnRules
        );
        context.registerSpawnPlacement(ModRegistry.DIRE_WOLF_ENTITY_TYPE.value(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                SpawnPlacementRules::checkDireWolfSpawnRules
        );
        context.registerSpawnPlacement(ModRegistry.FALLEN_MOUNT_ENTITY_TYPE.value(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                SpawnPlacementRules::checkMonsterSpawnRules
        );
        context.registerSpawnPlacement(ModRegistry.WITHER_CAT_ENTITY_TYPE.value(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                SpawnPlacementRules::checkMonsterSpawnRules
        );
        context.registerSpawnPlacement(ModRegistry.WITHER_WITCH_ENTITY_TYPE.value(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                SpawnPlacementRules::checkSurfaceSpawnRules
        );
        context.registerSpawnPlacement(ModRegistry.OWL_ENTITY_TYPE.value(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING,
                SpawnPlacementRules::checkOwlSpawnRules
        );
        context.registerSpawnPlacement(ModRegistry.FALLEN_KNIGHT_ENTITY_TYPE.value(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                SpawnPlacementRules::checkSurfaceSpawnRules
        );
        ...
        context.register(BiomeLoadingPhase.ADDITIONS, loadingContext -> {
            ...
            if (CONFIG.get(CommonConfig.class).concussionCreeper) {
                registerSpawnData(settings,
                        MobCategory.MONSTER,
                        EntityType.CREEPER,
                        data -> new MobSpawnSettings.SpawnerData(ModRegistry.CONCUSSION_CREEPER_ENTITY_TYPE.value(),
            ...
            if (CONFIG.get(CommonConfig.class).infestedZombie) {
                registerSpawnData(settings,
                        MobCategory.MONSTER,
                        EntityType.ZOMBIE,
                        data -> new MobSpawnSettings.SpawnerData(ModRegistry.INFESTED_ZOMBIE_ENTITY_TYPE.value(),
                                Math.max(1, data.getWeight().asInt() / 4),
                                1,
                                data.maxCount
                        )
            ...
            if (CONFIG.get(CommonConfig.class).fallenKnight) {
                registerSpawnData(settings,
                        MobCategory.MONSTER,
                        EntityType.ZOMBIE,
                        data -> new MobSpawnSettings.SpawnerData(ModRegistry.FALLEN_KNIGHT_ENTITY_TYPE.value(),
                                Math.max(1, data.getWeight().asInt() / 4),
                                4,
                                6
                        )
            ...
            if (CONFIG.get(CommonConfig.class).enderminy) {
                registerSpawnData(settings,
                        MobCategory.MONSTER,
                        EntityType.ENDERMAN,
                        data -> new MobSpawnSettings.SpawnerData(ModRegistry.ENDERMINY_ENTITY_TYPE.value(),
                ...
                if (modificationContext.climateSettings().hasPrecipitation() &&
                    ...
                    findVanillaSpawnData(settings, MobCategory.CREATURE, EntityType.WOLF).ifPresent(data -> {
                        settings.addSpawn(MobCategory.MONSTER,
                                new MobSpawnSettings.SpawnerData(ModRegistry.DIRE_WOLF_ENTITY_TYPE.value(),
                                        Math.max(1, data.getWeight().asInt() / 4),
                                        3,
                                        8
                                )
            ...
            if (CONFIG.get(CommonConfig.class).witherWitch) {
                registerSpawnData(settings,
                        MobCategory.MONSTER,
                        EntityType.WITCH,
                        data -> new MobSpawnSettings.SpawnerData(ModRegistry.WITHER_WITCH_ENTITY_TYPE.value(),
                                data.getWeight(),
                                data.minCount,
                                data.maxCount
                        )
                ...
                if (modificationContext.climateSettings().hasPrecipitation()) {
                    findVanillaSpawnData(settings, MobCategory.CREATURE, EntityType.RABBIT).ifPresent(data -> {
                        settings.addSpawn(MobCategory.CREATURE,
                                new MobSpawnSettings.SpawnerData(ModRegistry.OWL_ENTITY_TYPE.value(),
                                        data.getWeight(),
                                        data.minCount,
                                        data.maxCount
                                )
    ...
    public void onRegisterCreativeModeTabs(CreativeModeTabContext context) {
        context.registerCreativeModeTab(CreativeModeTabConfigurator.from(MOD_ID)
                .icon(() -> new ItemStack(ModRegistry.ENDER_FRAGMENT_ITEM.value()))
                ...
                .displayItems((itemDisplayParameters, output) -> {
                    ...
                    output.accept(ModRegistry.ENDERIOS_ITEM.value());
                    output.accept(ModRegistry.ENDER_CHARGE_MINECART_ITEM.value());
                    output.accept(ModRegistry.CONFUSING_CHARGE_MINECART_ITEM.value());
                    output.accept(ModRegistry.CONCUSSION_CHARGE_MINECART_ITEM.value());
