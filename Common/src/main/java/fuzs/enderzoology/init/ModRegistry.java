...
public class ModRegistry {
    ...
    public static final RegistryReference<EntityType<InfestedZombie>> INFESTED_ZOMBIE_ENTITY_TYPE = REGISTRY.registerEntityTypeBuilder("infested_zombie", () -> EntityType.Builder.of(InfestedZombie::new, MobCategory.MONSTER).sized(0.6F, 1.95F).clientTrackingRange(8));
    ...
    public static final RegistryReference<Item> INFESTED_ZOMBIE_SPAWN_EGG_ITEM = REGISTRY.whenNotOn(ModLoader.FORGE).registerItem("infested_zombie_spawn_egg", () -> new SpawnEggItem(INFESTED_ZOMBIE_ENTITY_TYPE.get(), 0x132F55, 0x2B2D1C, new Item.Properties().tab(CREATIVE_MODE_TAB)));
