...
public class ModRegistry {
    ...
    public static final RegistryReference<Item> GUARDIANS_BOW_ITEM = REGISTRY.registerItem("guardians_bow", () -> new BowItem(new Item.Properties().durability(768).tab(CREATIVE_MODE_TAB)));
