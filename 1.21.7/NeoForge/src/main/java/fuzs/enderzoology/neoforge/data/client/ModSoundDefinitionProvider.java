...
public class ModSoundDefinitionProvider extends AbstractSoundProvider {
    ...
    public void addSounds() {
        this.add(ModSoundEvents.DIRE_WOLF_HURT_SOUND_EVENT.value(),
                SoundDefinitionsProvider.sound(this.id("mob/dire_wolf/hurt")));
        this.add(ModSoundEvents.DIRE_WOLF_DEATH_SOUND_EVENT.value(),
                SoundDefinitionsProvider.sound(this.id("mob/dire_wolf/death")));
        this.add(ModSoundEvents.DIRE_WOLF_GROWL_SOUND_EVENT.value(),
                SoundDefinitionsProvider.sound(this.id("mob/dire_wolf/growl1")),
                SoundDefinitionsProvider.sound(this.id("mob/dire_wolf/growl2")),
                SoundDefinitionsProvider.sound(this.id("mob/dire_wolf/growl3")));
        this.add(ModSoundEvents.DIRE_WOLF_HOWL_SOUND_EVENT.value(),
                SoundDefinitionsProvider.sound(this.id("mob/dire_wolf/howl")));
        this.add(ModSoundEvents.OWL_HOOT_SOUND_EVENT.value(),
                SoundDefinitionsProvider.sound(this.id("mob/owl/hoot1")).volume(0.2F),
                SoundDefinitionsProvider.sound(this.id("mob/owl/hoot2")).volume(0.2F));
        this.add(ModSoundEvents.OWL_HURT_SOUND_EVENT.value(),
                SoundDefinitionsProvider.sound(this.id("mob/owl/hurt")).volume(0.2F));
